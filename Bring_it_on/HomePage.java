...
public class HomePage {
    ...
    private WebElement syntaxHighlightingMain;

    @FindBy(xpath="//*[@id='select2-postform-format-results']/li[2]/ul/li[text()='Bash']")
    ...
    public HomePage syntaxHighlightingToBash(){
        syntaxHighlightingMain.click();
    ...
    public HomePage pasteButtonClick (){
        pasteButton.click();
        return this;
    }
